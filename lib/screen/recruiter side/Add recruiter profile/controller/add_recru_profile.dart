...
class AddRecrPforileProvider with ChangeNotifier{
  ...
  Future<void> checkAddRecruiter()async{
    ...
    final addrecruiterProfile = RecruiterProfileModel(companyName: companyName, establishedDate: selectedDate as EstablishedDate, companyEmail: companyEmail, country: country, address: companyAddress);
